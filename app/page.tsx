...
export default async function Home() {
	...
	return (
		<div className="h-dvh flex flex-col overflow-hidden">
			<div className="flex items-center justify-center mt-10 gap-0 mx-4">
				<svg
					viewBox="0 0 339 124"
				...
				<div className="font-kanit text-center font-medium italic text-2xl md:text-5xl">CBB Composite Rankings</div>
				<svg
